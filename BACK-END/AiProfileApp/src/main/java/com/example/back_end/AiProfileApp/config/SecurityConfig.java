        ...
        http.cors(Customizer.withDefaults()).csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/v1/auth/login", "/v1/auth/register", "/v1/auth/validate-verification-code",
                                "/v1/auth/send-verification-code", "/v1/auth/change-password", "/v1/documentation/**",
                                "/swagger-ui.html", "/swagger-resources/**", "/swagger-ui/**", "/api-docs/**",
                                "/api/api-docs/**", "/v3/api-docs/**", "/webjars/**")
