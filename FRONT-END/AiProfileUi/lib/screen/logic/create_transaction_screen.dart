...
class _CreateTransactionScreenState extends State<CreateTransactionScreen> {
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                Text(
                  'Transacción ${_selectedType == 'INCOME' ? 'de ingreso' : 'de gasto'} creada exitosamente',
                ),
              ],
            ),
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                const SizedBox(width: 8),
                Expanded(child: Text('Error al crear transacción: $e')),
              ],
            ),
  ...
  Widget build(BuildContext context) {
    final typeColor =
        _selectedType == 'INCOME' ? context.incomeColor : context.expenseColor;
      ...
      child: Column(
        ...
        children: [
          ...
          TextFormField(
            ...
            onChanged:
                (value) => setState(() {}), // Para actualizar el contador
          ),
        ],
      ),
    );
  ...
  Widget _buildSaveButton(Color typeColor) {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Los ingresos aumentan tu balance, los gastos lo disminuyen. Puedes editar esta transacción más tarde.',
                  style: TextStyle(
                    fontSize: AppConstants.fontSizeSmall,
                    color: Colors.grey.shade600,
                  ),
